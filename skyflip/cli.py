...
def build_parser() -> argparse.ArgumentParser:
    ...
    analyze_parser.add_argument("--use-buy-order-cost", action=argparse.BooleanOptionalAction, default=True)
...
def _add_dashboard_args(dashboard_parser: argparse.ArgumentParser) -> None:
    ...
    advanced.add_argument("--use-buy-order-cost", action=argparse.BooleanOptionalAction, default=True)
